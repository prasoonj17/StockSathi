...
const SignUpPage = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.mobile) {
      newErrors.mobile = VALIDATION_MESSAGES.MOBILE_REQUIRED;
    } else if (!MOBILE_REGEX.test(formData.mobile)) {
      newErrors.mobile = VALIDATION_MESSAGES.MOBILE_INVALID;
    }
    if (!formData.email) {
  ...
  const handleSubmit = (e) => {
    ...
    // Frontend-only: Simulate form submission success
  ...
  return (
    <>
      <Helmet>
        <title>StockSathi - Sign Up</title>
        <meta
          name="description"
          content="Sign up for StockSathi to start managing your investments securely."
        />
